...
impl BlockArchetype {
  pub fn new(block_type: BlockType,
             name: &'static str,
             category: &'static str,
    ...
    match n {
      ...
      BlockType::EFFECT(st) => {
        match st {
          ...
          EffectType::C2P => Self::new(n, "cartopol", "Coordinates", vec!["x", "y"], vec!["r", "θ"]),
          EffectType::S2C =>
...
pub struct Terminal {
  pub pos: Pos2, //uhg
  pub parent: BlockId, //even more uhg
  pub val: Option<f32>, //not funny anymore
  pub name: String,
  pub io: TermType,
}

impl Terminal {
  pub(crate) fn new(name: &'static str, io: TermType, owner: BlockId, val: Option<f32>) -> Self {
    Self {
      pos: Pos2::default(),
      parent: owner,
      val: None,
